...
<body>
<form name="writeForm" method="post" action="/mvcmemberr/member/modify.do">
   <table border="1" cellspacing="0" cellpadding="5">
      ...
      <tr>
         ...
         <td>
            <input type="text" name="id" id="id" value="${sessionScope.memId }">
            <input type="button" value="중복체크" id="checkIdBtn" ><!-- //onclick="checkId()" -->
      ...
      <tr>
         ...
         <td>
            <input type="password" name="pwd" id="pwd" size="30" value="${sessionScope.memPwd }">
            <div id= "pwdDiv"></div>
         </td>   
      </tr>
      ...
      <tr>
         <td colspan="2" align="center">
            <input type="submit" id="writeBtn" value="회원정보수정" >
